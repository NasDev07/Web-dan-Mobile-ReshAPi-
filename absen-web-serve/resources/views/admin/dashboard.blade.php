        ...
        <div class="row my-3">
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success">
                    ...
                    <a href="{{ url('/mahasiswa/dosen') }}" class="small-box-footer">More info <i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-warning">
                    ...
                    <a href="{{ url('/mahasiswa/create') }}" class="small-box-footer">More info <i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
        </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-action="selectDay" data-day="05/21/2022"
                                                        class="day active today weekend">21</td>
                                                </tr>
                                                <tr>
